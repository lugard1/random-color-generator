...
## Learning Objectives
- Understand how to replicate a cool random color generator application which can be adopted for different applications as good color combination supports beautiful user interfaces.

## Description of the Project
For the first milestone in the process of creating Random color generator application, you will:
